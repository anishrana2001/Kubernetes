...
kubectl -n cka expose deployment devops-wala.com-cka --name=srv-cka --port=8081 --target-port=80
...
kubectl -n ckad create configmap ckad-page --from-file=index.html
...
## kubectl -n ckad expose deployment devops-wala.com-ckad --name=srv-ckad --port=8082 --target-port=80
