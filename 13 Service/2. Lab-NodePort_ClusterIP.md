...
kubectl delete deployment.apps/backend-deployment service/hello-srv service/frontend-srv deployment.apps/frontend-deployment
cd /data-service
rm -f /data-service/frontendser.yaml /data-service/service_project.yaml /data-service/IPAddressPool.yaml /data-service/l2advertise.yaml /data-service/hello-srv.yaml /data-service/backend-deployment.yaml /data-service/frontend-srv.yaml /data-service/frontend-deployment.yaml
cd ..
rmdir /data-service
```
